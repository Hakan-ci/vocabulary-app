...
export type Operation = { id: string; protocol?: 2|3|4; kind: OperationKind; at: number; notBefore?:number; undoLabel?:string; changes: Change[]; status: 'pending' | 'conflict'; message?: string; expectedRevision?: number; migrationId?: string }
export type SyncCache = { version: 4; selections?:{daily?:string;review?:string}; identities: IdentityMap; migrationIdentities?: IdentityMap; base: CloudSnapshot; queue: Operation[]; backups: Operation[]; initialized: boolean; migrationChoice?: 'account' | 'imported' }
